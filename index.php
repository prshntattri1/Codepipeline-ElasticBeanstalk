...
<body>
    <section class="congratulations">
        <h1> HeyCongratulations! It works!</h1>
        <p>AWS Elastic Beanstalk with CodePipeline <em>PHP</em> application is now running on your own dedicated environment in the AWS&nbsp;Cloud</p>
